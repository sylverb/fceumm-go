...
void OPLL_NES_delete(OPLL *);

void OPLL_NES_reset(OPLL *);
void OPLL_NES_resetPatch(OPLL *, uint8_t);
 ...
 * ```
 */
void OPLL_NES_setPan(OPLL *opll, uint32_t ch, uint8_t pan);
 ...
 */
void OPLL_NES_setChipType(OPLL *opll, uint8_t type);

void OPLL_NES_writeIO(OPLL *opll, uint32_t reg, uint8_t val);
void OPLL_NES_writeReg(OPLL *opll, uint32_t reg, uint8_t val);
...
void OPLL_NES_setPatch(OPLL *, const uint8_t *dump);
void OPLL_NES_copyPatch(OPLL *, int32_t, OPLL_PATCH *);

/**
 * Force to refresh.
 * External program should call this function after updating patch parameters.
 */
void OPLL_NES_forceRefresh(OPLL *);
...
void OPLL_NES_getDefaultPatch(int32_t type, int32_t num, OPLL_PATCH *);
 ...
 */
uint32_t OPLL_NES_setMask(OPLL *, uint32_t mask);

/**
 * Toggler channel mask flag
 */
uint32_t OPLL_NES_toggleMask(OPLL *, uint32_t mask);

void OPLL_NES_fillbuf(OPLL*, int32_t *buf, int32_t len, int shift);
